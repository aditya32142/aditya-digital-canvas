...
const items = [
  ...
  },
  {
    ...
    detail:
      "Remote work using Google Sheets for data organization, cleaning, and workflow coordination across teams.",
    tag: "Experience",
  },
  {
    icon: Trophy,
    ...
    detail:
      "Built an IoT + AI-powered agriculture solution; reached the finals at a national-level innovation competition.",
    tag: "Achievement",
  },
];
        ...
        <div className="grid gap-10 lg:grid-cols-12">
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            <p className="text-foreground/70 leading-relaxed">
              Aspiring Software Developer with strong foundations in C++, Java,
              and Data Structures & Algorithms. Skilled in problem-solving,
              object-oriented programming, and building scalable user-focused
              solutions.
            </p>
