...
const featured = {
  ...
  prototype:
    "https://www.figma.com/make/L4YTZnIRyx8mv2dZt8O9Re/LeadOps-CRM?fullscreen=1&t=f8cr6mxTqEUhXdAb-1&code-node-id=0-9",
};
      ...
      <div className="mx-auto max-w-7xl px-5 md:px-8">
        ...
        <div className="relative mb-16">
          ...
          <div className="relative flex flex-wrap items-end justify-between gap-4 pt-8">
            ...
            <p className="max-w-md text-foreground/60">
              A glimpse into the products I've designed and built —
              focused on real workflows, clean UX and scalable architecture.
            </p>
        ...
        >
          ...
          <div className="lg:col-span-5 flex flex-col">
            ...
            <h4 className="mt-2 font-display text-3xl md:text-4xl font-bold">
              {featured.title}
            </h4>
            ...
            {/* ONLY PROTOTYPE BUTTON */}
            <div className="mt-auto pt-6">

              <a
                href={featured.prototype}
                target="_blank"
                rel="noreferrer"
                className="inline-flex items-center gap-2 rounded-full border border-border px-5 py-3 text-sm font-semibold hover:border-gold hover:text-gold transition-all"
              >
                <Play size={15} />
                View Prototype
              </a>
              ...
              <div className="p-6">
                ...
                <div className="flex items-start justify-between gap-4">
                  ...
                  <div>
                    ...
                    <h4 className="mt-1 font-display text-2xl font-bold">
                      {p.title}
                    </h4>
                  </div>
